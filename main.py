...
class TrainerACE:
            ...
            while buffer_idx < self.options.training_buffer_size:
                ...
                for (
                    ...
                    mask_from_pretrained, pid_list = self.retrieve_gt_xyz(
                        image_ori, frame_path, gt_pose_inv_B44, intrinsics_B33, H, W,
                    )
    ...
    def retrieve_gt_xyz(
        self, image_ori, frame_path, gt_pose_inv_B44, intrinsics_B33, H, W,
    ):
        batch_idx = 0
        xyz = None
        ...
        with torch.no_grad():
            for (
                ...
                uv_arr2, xyz_pred2 = self.legal_predict(
                    model, keypoints, descriptors, gpu_index_flat, structured=True,
                )
