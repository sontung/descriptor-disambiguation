...
/home/n11373598/.pixi/bin/pixi run python main_robotcar.py --convert 0 --dataset /work/qvpr/data/raw/2020VisualLocalization/RobotCar-Seasons --global_desc megaloc || {
  echo "Python crashed!"
  exit 1
}
