...
/home/n11373598/.pixi/bin/pixi run python main_robotcar.py --dataset /work/qvpr/data/raw/2020VisualLocalization/RobotCar-Seasons --local_desc d2net --local_desc_dim 512 --global_desc megaloc --global_desc_dim 8448 || {
  echo "Python crashed!"
  exit 1
}
