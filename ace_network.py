...
class DescNet(nn.Module):
    ...
    def __init__(self, tiny=0, feature_dim=128):
        """
        Constructor.
        """
        super(DescNet, self).__init__()

        self.conv1 = nn.Conv1d(feature_dim, 32, 3, 1, 1)
        self.conv2 = nn.Conv1d(32, 64, 3, 2, 1)
        self.conv3 = nn.Conv1d(64, 128, 3, 2, 1)
        self.conv4 = nn.Conv1d(128, (256, 128)[tiny], 3, 2, 1)

        self.res1_conv1 = nn.Conv1d((256, 128)[tiny], (256, 128)[tiny], 3, 1, 1)
        self.res1_conv2 = nn.Conv1d((256, 128)[tiny], (256, 128)[tiny], 1, 1, 0)
        self.res1_conv3 = nn.Conv1d((256, 128)[tiny], (256, 128)[tiny], 3, 1, 1)

        self.res2_conv1 = nn.Conv1d((256, 128)[tiny], (512, 128)[tiny], 3, 1, 1)
        self.res2_conv2 = nn.Conv1d((512, 128)[tiny], (512, 128)[tiny], 1, 1, 0)
        self.res2_conv3 = nn.Conv1d((512, 128)[tiny], (512, 128)[tiny], 3, 1, 1)

        if not tiny:
            self.res2_skip = nn.Conv1d(256, 512, 1, 1, 0)

        self.res3_conv1 = nn.Conv1d((512, 128)[tiny], (512, 128)[tiny], 1, 1, 0)
        self.res3_conv2 = nn.Conv1d((512, 128)[tiny], (512, 128)[tiny], 1, 1, 0)
        self.res3_conv3 = nn.Conv1d((512, 128)[tiny], (512, 128)[tiny], 1, 1, 0)

        self.fc1 = nn.Conv1d((512, 128)[tiny], (512, 128)[tiny], 1, 1, 0)
        self.fc2 = nn.Conv1d((512, 128)[tiny], (512, 128)[tiny], 1, 1, 0)
        self.fc3 = nn.Conv1d((512, 128)[tiny], 1, 1, 1, 0)
...
if __name__ == "__main__":
    m = DescNet()
    inp = torch.randn((3, 128, 1), requires_grad=True)
    v = m(inp)
    print()
